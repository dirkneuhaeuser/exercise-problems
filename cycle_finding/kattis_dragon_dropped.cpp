...
pair<bool, bool> returnT(){
    cout << "RETURN GABBY" << endl;
    cout.flush();
    int i1, i2;
    cin >> i1 >> i2;
    return {i1, i2};
}
pair<bool, bool> returnH(){
...
void solve() 
{
    // i have tested this code on various inputs, but it doenst pass tests on kattis...if u find the bug, tell me :P
    int n; cin>>n;
    pair<bool, bool>  t= ft(), h = fh();
    h = fh();
