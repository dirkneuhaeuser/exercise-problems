...
void solve() 
{
    ...
    while(cin>>n>>m){
        ...
        while(n>stop){
            ...
            // in wc 20KK multiplications withs big numbers...even with trailing zeros -> overflow && tle
            pos%=MOD; // main idea: multiplication is costy. With %MOD we dont destory the last important digit and also wenn generting new 0, the next few non zeros are still correct
        }
        cout << pos%10 << endl;
