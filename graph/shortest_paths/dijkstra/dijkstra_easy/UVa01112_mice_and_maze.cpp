...
int main() 
{
    ...
    cerr<<"tim  taken : "<<(float)clock()/CLOCKS_PER_SEC<<" secs"<<endl; 
    return 0; 
} 
...
void solve() 
{
    // sssp but with edges reversed, as we do not consider s to be start but exit
