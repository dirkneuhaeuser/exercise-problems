...
public:
    SegmentTree(ll size) : n(size) {
        NO_VALUE.minN=INF; // TODO;
        st.assign(4*size, NO_VALUE); // 4 = 2*2. First 2: to make n a factor of two [actualy 2 * upper(log_2(n))], and second 2 for the inner nodes of the tree
    }
